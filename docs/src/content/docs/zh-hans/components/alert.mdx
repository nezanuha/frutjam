...
name: "警报"
heading: "警报组件"
description: "仅限 CSS Tailwind CSS 警报，包含信息、成功、警告和错误变体。柔和的风格、图标槽和可忽略的图案。 WCAG AA 可访问，可与 Django、HTMX、Laravel、React 和任何堆栈配合使用。"
metaTitle: "警报 - 仅 CSS 的 Tailwind CSS 组件 |Frutjam"
metaDescription: "不含 JS 的 Tailwind CSS 警报，包含信息、成功、警告和错误变体。可访问、图标就绪且主题感知，可实现有效的页内通知。"
order: 0
related:
  - "components/toast"
  - "components/button"
...
| 班级 | 类型 | 描述 |
| --- | --- | --- |
| alert | <span class="badge badge-xs">根据</span> | 上下文消息横幅 |
| alert-outline | <span class="badge badge-xs badge-success badge-soft">风格</span> | 带彩色边框的透明填充 |
| alert-soft | <span class="badge badge-xs badge-success badge-soft">风格</span> | 柔和的有色背景 |
| alert-ghost | <span class="badge badge-xs badge-success badge-soft">风格</span> | 微妙的背景，无边框 |
| alert-dashed | <span class="badge badge-xs badge-success badge-soft">风格</span> | 虚线边框样式 |
| alert-pill | <span class="badge badge-xs badge-success badge-soft">风格</span> | 全圆形药丸形状 |
| alert-rounded | <span class="badge badge-xs badge-success badge-soft">风格</span> | 适度舍入 |
| alert-horizontal | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | 水平弹性布局 |
| alert-vertical | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | 垂直堆叠布局 |
| alert-xs | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 特小号 |
| alert-sm | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 小的 |
| alert-md | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 中（默认） |
| alert-lg | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 大的 |
| alert-primary | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 主要主题颜色 |
| alert-secondary | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 次要主题色 |
| alert-accent | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 强调主题颜色 |
| alert-neutral | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 中性主题色 |
| alert-info | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 信息语义颜色 |
| alert-success | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 成功语义色 |
| alert-warning | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 警告语义颜色 |
| alert-error | <span class="badge badge-xs badge-warning badge-soft">颜色</span> | 错误语义颜色 |
...
使用 `w-full` 实用程序类使**警报**跨越其容器的整个宽度。这适用于所有颜色和款式变体。
...
此警报在移动设备上垂直堆叠，并在桌面上水平扩展，以实现最佳的屏幕使用。
