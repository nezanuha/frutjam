...
description: "Alerta Tailwind CSS somente CSS com variantes de informações, sucesso, aviso e erro. Estilo suave, slot de ícone e padrão descartável. WCAG AA acessível, funciona com Django, HTMX, Laravel, React e qualquer pilha."
metaTitle: "Alerta - Componente CSS Tailwind somente CSS | Frutjam"
metaDescription: "Alerta CSS Tailwind sem JS com variantes de informações, sucesso, aviso e erro. Acessível, pronto para ícones e com reconhecimento de tema para notificações eficazes na página."
order: 0
related:
  - "components/toast"
  - "components/button"
...
| Aula | Tipo | Descrição |
| --- | --- | --- |
| alert | <span class="badge badge-xs">Base</span> | Banner de mensagem contextual |
| alert-outline | <span class="badge badge-xs badge-success badge-soft">Estilo</span> | Preenchimento transparente com borda colorida |
| alert-soft | <span class="badge badge-xs badge-success badge-soft">Estilo</span> | Fundo colorido silenciado |
| alert-ghost | <span class="badge badge-xs badge-success badge-soft">Estilo</span> | Fundo sutil sem borda |
| alert-dashed | <span class="badge badge-xs badge-success badge-soft">Estilo</span> | Estilo de borda tracejada |
| alert-pill | <span class="badge badge-xs badge-success badge-soft">Estilo</span> | Formato de comprimido totalmente arredondado |
| alert-rounded | <span class="badge badge-xs badge-success badge-soft">Estilo</span> | Arredondamento moderado |
| alert-horizontal | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Layout flexível horizontal |
| alert-vertical | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Layout empilhado verticalmente |
| alert-xs | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Extra pequeno |
| alert-sm | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Pequeno |
| alert-md | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Médio (padrão) |
| alert-lg | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Grande |
| alert-primary | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor do tema principal |
| alert-secondary | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor do tema secundário |
| alert-accent | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor do tema de destaque |
| alert-neutral | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor neutra do tema |
| alert-info | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor semântica da informação |
| alert-success | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor semântica de sucesso |
| alert-warning | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor semântica de aviso |
| alert-error | <span class="badge badge-xs badge-warning badge-soft">Cor</span> | Cor semântica do erro |
...
## Layout e comportamento do alerta

### Alertas de largura total

Use a classe de utilitário `w-full` para fazer um **alerta** abranger toda a largura do seu contêiner. Isso funciona com todas as variantes de cores e estilos.
...
### Empilhamento de alertas responsivos

Esse alerta é empilhado verticalmente em dispositivos móveis e expandido horizontalmente em computadores para otimizar o uso da tela.
