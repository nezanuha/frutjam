---
name: "Đếm ngược"
heading: "Thành phần đếm ngược"
description: "Đồng hồ đếm ngược CSS Tailwind chỉ dành cho CSS. Hiển thị số hoạt hình cho ngày, giờ, phút và giây. WCAG AA có thể truy cập được, hoạt động với Django, HTMX, Laravel, React và bất kỳ ngăn xếp nào."
metaTitle: "Đếm ngược - Thành phần CSS Tailwind chỉ dành cho CSS | Frutjam"
metaDescription: "Tailwind CSS Countdown cho các sự kiện ra mắt, đợt giảm giá chớp nhoáng và thời hạn. Hỗ trợ ngày, giờ, phút và giây với bố cục sinh động, linh hoạt."
order: 0
related:
  - "components/stat"
  - "components/badge"
image: "https://cdn.frutjam.com/media/components/countdown_CQdyWIi.webp"
imageAlt: "Đếm ngược bởi Frutjam"
createdAt: "2026-04-19T15:56:37.063056+00:00"
updatedAt: "2026-07-13T09:52:22.878683+00:00"
sourceHash: "7a4576b06648"
translationHash: "dbacd6feb1ad"
---
...
| --- | --- | --- |
| countdown | <span class="badge badge-xs">Căn cứ</span> | Animated numeric digit driven by `--countdown-value` |
| countdown-xs | <span class="badge badge-xs badge-info badge-soft">Kích cỡ</span> | Cực nhỏ |
| countdown-sm | <span class="badge badge-xs badge-info badge-soft">Kích cỡ</span> | Bé nhỏ |
| countdown-md | <span class="badge badge-xs badge-info badge-soft">Kích cỡ</span> | Trung bình (mặc định) |
| countdown-lg | <span class="badge badge-xs badge-info badge-soft">Kích cỡ</span> | Lớn |
| countdown-xl | <span class="badge badge-xs badge-info badge-soft">Kích cỡ</span> | Cực lớn |
