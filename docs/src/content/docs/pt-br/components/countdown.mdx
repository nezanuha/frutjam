...
heading: "Componente de contagem regressiva"
description: "Temporizador de contagem regressiva Tailwind CSS somente CSS. Exibição de números animados para dias, horas, minutos e segundos. WCAG AA acessível, funciona com Django, HTMX, Laravel, React e qualquer pilha."
metaTitle: "Contagem regressiva - Componente CSS Tailwind somente CSS | Frutjam"
metaDescription: "Contagem regressiva CSS Tailwind para lançamentos de eventos, vendas relâmpago e prazos. Suporta dias, horas, minutos e segundos com layouts flexíveis e animados."
order: 0
related:
  - "components/stat"
  - "components/badge"
image: "https://cdn.frutjam.com/media/components/countdown_CQdyWIi.webp"
imageAlt: "Contagem regressiva de Frutjam"
createdAt: "2026-04-19T15:56:37.063056+00:00"
updatedAt: "2026-07-13T09:52:22.878683+00:00"
sourceHash: "7a4576b06648"
translationHash: "44e593d80b0e"
---
...
Os componentes de contagem regressiva exibem o tempo restante até o término de um evento, prazo ou promoção. Construídas com exibições numéricas animadas, as contagens regressivas criam urgência e expectativa. O sistema de contagem regressiva Frutjam oferece suporte a vários tamanhos, formatos e estilos - ideal para vendas relâmpago, cronômetros de eventos, contagens regressivas de lançamento e ofertas por tempo limitado.
...
| Aula | Tipo | Descrição |
| --- | --- | --- |
| countdown | <span class="badge badge-xs">Base</span> | Dígito numérico animado orientado por `--countdown-value` |
| countdown-xs | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Extra pequeno |
| countdown-sm | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Pequeno |
| countdown-md | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Médio (padrão) |
| countdown-lg | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Grande |
| countdown-xl | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Extra grande |
...
## Tamanhos de contagem regressiva
