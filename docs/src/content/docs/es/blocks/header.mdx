...
description: "Bloques de encabezado CSS Tailwind solo para CSS con barra de navegación, marca y cajón móvil. Variantes de diseño adhesivo, transparente y responsivo. Accesible a WCAG AA, funciona con Django, HTMX, Laravel, React y cualquier pila."
metaTitle: "Encabezado | Bloque CSS Tailwind solo CSS | Frutjam"
metaDescription: "Bloques de encabezado CSS Tailwind solo CSS con diseños adhesivos, responsivos y de marca. Sin JavaScript, accesible WCAG AA. Funciona con Django, HTMX, Laravel, React y cualquier pila."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Diseños de encabezado listos para usar creados con el componente de encabezado [](/components/header), [navbar](/components/navbar) y [drawer](/components/drawer) para dispositivos móviles.
