---
title: Sidebar
description: Sidebar components organize primary navigation and auxiliary content in a fixed or collapsible side panel. Built with semantic HTML, sidebars improve navigation
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

<p>Sidebar components organize primary navigation and auxiliary content in a fixed or collapsible side panel. Built with semantic HTML, sidebars improve navigation without consuming main content space. The Frutjam sidebar system supports multiple layouts, widths, and behaviors—ideal for admin dashboards, documentation sites, and complex applications.</p>
...
<div class="overflow-y-auto max-h-72">
  <table class="table table-sm not-prose">
    ...
    <tbody>
      <tr><td>sidebar</td><td><span class="badge badge-xs">Base</span></td><td>Fixed side panel for navigation and auxiliary content</td></tr>
    </tbody>
  </table>
</div>

<h2>Basic Usage</h2>
<p>Use the <code>sidebar</code> class on an <code>aside</code> element. Place it alongside your main content in a flex container.</p>
...
<p>A full navigation sidebar with grouped sections and active state styling.</p>
...
<p>For mobile or overlay sidebars, combine the <code>sidebar</code> class with the <code>drawer drawer-start</code> dialog component.</p>
