...
name: "抽屉"
heading: "抽屉组件"
description: "仅 CSS Tailwind CSS 抽屉使用本机复选框切换。滑入式侧面板可用于导航或过滤器，无需 JavaScript。 WCAG AA 可访问，可与 Django、HTMX、Laravel、React 和任何堆栈配合使用。"
metaTitle: "抽屉 - 仅 CSS Tailwind CSS 组件 |Frutjam"
metaDescription: "无需 JS 的 Tailwind CSS 抽屉，用于画布外导航和侧边栏。具有覆盖支持的多个位置 - 无需 JavaScript 即可访问且适合移动设备。"
order: 0
related:
  - "components/navbar"
  - "components/modal"
...
| 班级 | 类型 | 描述 |
| --- | --- | --- |
| drawer | <span class="badge badge-xs">根据</span> | Slide-in panel built on the native dialog element |
| drawer-content | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | Inner content area of the drawer |
| drawer-backdrop | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | Overlay behind the drawer |
| drawer-start | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | Slides in from the left |
| drawer-end | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | Slides in from the right |
| drawer-top | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | Slides in from the top |
| drawer-bottom | <span class="badge badge-xs badge-secondary badge-soft">修饰符</span> | Slides in from the bottom |
