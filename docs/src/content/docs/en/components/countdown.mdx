---
name: "Countdown"
heading: "Countdown Component"
description: "CSS-only Tailwind CSS countdown timer. Animated number display for days, hours, minutes, and seconds. WCAG AA accessible, works with Django, HTMX, Laravel, React, and any stack."
metaTitle: "Countdown - CSS-Only Tailwind CSS Component | Frutjam"
metaDescription: "Tailwind CSS Countdown for event launches, flash sales, and deadlines. Supports days, hours, minutes, and seconds with flexible, animated layouts."
order: 0
related:
  - "components/stat"
  - "components/badge"
image: "https://cdn.frutjam.com/media/components/countdown_CQdyWIi.webp"
imageAlt: "Countdown by Frutjam"
...
CSS-only Tailwind CSS countdown timer. Animated number display for days, hours, minutes, and seconds. WCAG AA accessible, works with Django, HTMX, Laravel, React, and any stack.
...
| countdown-xs | <span class="badge badge-xs badge-info badge-soft">Size</span> | Extra small |
| countdown-sm | <span class="badge badge-xs badge-info badge-soft">Size</span> | Small |
| countdown-md | <span class="badge badge-xs badge-info badge-soft">Size</span> | Medium (default) |
| countdown-lg | <span class="badge badge-xs badge-info badge-soft">Size</span> | Large |
| countdown-xl | <span class="badge badge-xs badge-info badge-soft">Size</span> | Extra large |
