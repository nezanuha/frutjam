...
description: "CSS-only Tailwind CSS footer with multi-column layout, logo, links, and copyright slots. WCAG AA accessible, works with Django, HTMX, Laravel, React, and any Tailwind CSS v4 project."
metaTitle: "Footer - CSS-Only Tailwind CSS Component | Frutjam"
metaDescription: "Tailwind CSS Footer with multi-column layouts, social links, and brand sections. Semantic HTML5, SEO-friendly structure for responsive website footers."
order: 0
related:
  - "components/link"
  - "components/navbar"
image: "https://cdn.frutjam.com/media/components/footer_ISq8Ev8.webp"
imageAlt: "Footer by Frutjam"
...
| --- | --- | --- |
| footer | <span class="badge badge-xs">Base</span> | Page footer container with grid layout |
| footer-title | <span class="badge badge-xs badge-secondary badge-soft">Modifier</span> | Section heading inside the footer |
| footer-horizontal | <span class="badge badge-xs badge-secondary badge-soft">Modifier</span> | Horizontal single-row layout |
| footer-vertical | <span class="badge badge-xs badge-secondary badge-soft">Modifier</span> | Vertical stacked layout |
