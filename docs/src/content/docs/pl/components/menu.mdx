---
name: "Menu"
heading: "Składnik menu"
description: "Pionowe menu CSS Tailwind tylko dla CSS dla list nawigacyjnych. Stany elementów aktywnych, wyłączonych i ikon. Warianty rozmiarów. Dostępny WCAG AA, współpracuje z Django, HTMX, Laravel, React i dowolnym stosem."
metaTitle: "Menu — komponent CSS Tailwind tylko dla CSS | Frutjam"
metaDescription: "Menu CSS Tailwind dla list nawigacyjnych, pasków bocznych i list rozwijanych. Ikony, aktywne stany i zagnieżdżone podmenu — w pełni dostępne bez JavaScript."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
| Klasa | Typ | Opis |
| --- | --- | --- |
| menu | <span class="badge badge-xs">Opierać</span> | Pionowa lista elementów nawigacji lub działań |
| menu-item | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Indywidualna, klikalna pozycja w menu |
| menu-title | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Etykieta sekcji nieinteraktywnej |
| menu-horizontal | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Układ poziomy |
| menu-vertical | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Układ pionowy (domyślny) |
| menu-active | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Wymusza aktywny/podświetlony stan elementu |
| menu-disabled | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Wyłączony wygląd elementu menu |
| menu-xs | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Bardzo mały |
| menu-sm | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Mały |
| menu-md | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Średni (domyślny) |
| menu-lg | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Duży |
| menu-xl | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Bardzo duży |
...
## Menu responsywne: pionowe na małym ekranie, poziome na dużym ekranie
...
## Menu z pionową linią z tytułem jako rodzicem
...
## Menu pionowe zawierające tylko ikonę
...
## Menu poziome zawierające wyłącznie ikonę
...
## Menu z ikoną, tylko z podpowiedzią
...
## Menu z samą ikoną (poziomo) z podpowiedzią
...
## Mega menu z podmenu (responsywne)
...
## Składane z podmenu (responsywne)
