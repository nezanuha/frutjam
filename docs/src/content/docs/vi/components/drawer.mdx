---
name: "ngăn kéo"
heading: "Thành phần ngăn kéo"
description: "Ngăn CSS Tailwind chỉ dành cho CSS sử dụng nút chuyển đổi hộp kiểm gốc. Bảng điều khiển bên trượt để điều hướng hoặc bộ lọc không có JavaScript. WCAG AA có thể truy cập được, hoạt động với Django, HTMX, Laravel, React và bất kỳ ngăn xếp nào."
metaTitle: "Drawer - Thành phần CSS Tailwind chỉ dành cho CSS | Frutjam"
metaDescription: "Ngăn kéo CSS Tailwind không có JS để điều hướng và thanh bên ngoài canvas. Nhiều vị trí có hỗ trợ lớp phủ—có thể truy cập và thân thiện với thiết bị di động mà không cần JavaScript."
order: 0
related:
  - "components/navbar"
  - "components/modal"
...
| --- | --- | --- |
| drawer | <span class="badge badge-xs">Căn cứ</span> | Slide-in panel built on the native dialog element |
| drawer-content | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Inner content area of the drawer |
| drawer-backdrop | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Overlay behind the drawer |
| drawer-start | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Slides in from the left |
| drawer-end | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Slides in from the right |
| drawer-top | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Slides in from the top |
| drawer-bottom | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Slides in from the bottom |
