---
name: "Schublade"
heading: "Schubladenkomponente"
description: "Nur CSS-Tailwind-CSS-Schublade mit nativem Kontrollkästchen-Schalter. Einschiebbares Seitenpanel für Navigation oder Filter ohne JavaScript. WCAG AA zugänglich, funktioniert mit Django, HTMX, Laravel, React und jedem Stack."
metaTitle: "Drawer – Nur CSS-Tailwind-CSS-Komponente | Frutjam"
metaDescription: "JS-freies Tailwind CSS Drawer für Off-Canvas-Navigation und Seitenleisten. Mehrere Positionen mit Overlay-Unterstützung – zugänglich und mobilfreundlich ohne JavaScript."
order: 0
related:
  - "components/navbar"
  - "components/modal"
...
Schubladenkomponenten werden von den Seiten des Ansichtsfensters eingeschoben, um versteckte Navigation, Filter oder zusätzliche Inhalte anzuzeigen. Schubladen basieren auf dem nativen HTML-Dialogelement mit CSS-Animationen und bieten eine reaktionsfähige Möglichkeit, Layouts auf Mobil- und Desktop-Geräten zu verwalten. Das Frutjam-Schubladensystem unterstützt anpassbare Breiten, flüssige Animationen und Overlay-Hintergründe für eine professionelle Navigation in der Seitenleiste.
...
| --- | --- | --- |
| drawer | <span class="badge badge-xs">Base</span> | Einschiebbares Panel, das auf dem nativen Dialogelement aufbaut |
| drawer-content | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Innerer Inhaltsbereich der Schublade |
| drawer-backdrop | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Auflage hinter der Schublade |
| drawer-start | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Lässt sich von links einschieben |
| drawer-end | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Lässt sich von rechts einschieben |
| drawer-top | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Lässt sich von oben einschieben |
| drawer-bottom | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Lässt sich von unten einschieben |
...
Verwenden Sie `createDrawer` aus `frutjam/js` oder `useDrawer` aus `frutjam/react`, wenn sich der Trigger außerhalb der Schublade befindet oder Sie eine programmgesteuerte Steuerung von irgendwo in Ihrem Code benötigen.
...
Der `.drawer-backdrop` bietet einen anklickbaren Hintergrund, der die Schublade schließt, wenn außerhalb der Schublade geklickt wird. Durch Entfernen dieses Elements wird standardmäßig verhindert, dass die Schublade nicht geschlossen wird, wenn außerhalb der Schublade geklickt wird.

### Klicken Sie auf „Schließen“, wenn Sie auf „Hintergrund“ klicken
...
### Verhindern Sie das Schließen bei „Click Outside“.
...
## Schubladenplatzierungen

### Linke Schublade (Start)
