...
heading: "Composant de compte à rebours"
description: "Compte à rebours CSS Tailwind uniquement en CSS. Affichage animé des nombres pour les jours, les heures, les minutes et les secondes. WCAG AA accessible, fonctionne avec Django, HTMX, Laravel, React et n'importe quelle pile."
metaTitle: "Compte à rebours - Composant CSS Tailwind uniquement CSS | Frutjam"
metaDescription: "Compte à rebours Tailwind CSS pour les lancements d'événements, les ventes flash et les délais. Prend en charge les jours, les heures, les minutes et les secondes avec des mises en page flexibles et animées."
order: 0
related:
  - "components/stat"
  - "components/badge"
image: "https://cdn.frutjam.com/media/components/countdown_CQdyWIi.webp"
imageAlt: "Compte à rebours par Frutjam"
createdAt: "2026-04-19T15:56:37.063056+00:00"
updatedAt: "2026-07-13T09:52:22.878683+00:00"
sourceHash: "7a4576b06648"
translationHash: "910864e427c8"
---
...
Les composants de compte à rebours affichent le temps restant jusqu'à la fin d'un événement, d'une date limite ou d'une promotion. Construits avec des affichages numériques animés, les comptes à rebours créent urgence et anticipation. Le système de compte à rebours Frutjam prend en charge plusieurs tailles, formats et styles, idéal pour les ventes flash, les minuteries d'événements, les comptes à rebours de lancement et les offres à durée limitée.
...
| --- | --- | --- |
| countdown | <span class="badge badge-xs">Base</span> | Animated numeric digit driven by `--countdown-value` |
| countdown-xs | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Très petit |
| countdown-sm | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Petit |
| countdown-md | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Moyen (par défaut) |
| countdown-lg | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Grand |
| countdown-xl | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Très grand |
