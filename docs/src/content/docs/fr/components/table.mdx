---
name: "Tableau"
heading: "Composant de tableau"
description: "Table CSS Tailwind uniquement CSS avec rayures zébrées, tailles compactes et par défaut, colonnes épinglées et états de survol des lignes. WCAG AA accessible, fonctionne avec Django, HTMX, Laravel, React et n'importe quelle pile."
metaTitle: "Tableau - Composant CSS Tailwind uniquement CSS | Frutjam"
metaDescription: "Tableau CSS Tailwind avec des lignes rayées, des en-têtes collants et un dimensionnement compact. HTML sémantique pour un affichage de données accessible et réactif dans les tableaux de bord et les listes."
order: 0
related:
  - "components/checkbox"
  - "components/button"
...
| --- | --- | --- |
| table | <span class="badge badge-xs">Base</span> | Styled HTML table with consistent spacing |
| table-zebra | <span class="badge badge-xs badge-success badge-soft">Style</span> | Alternating row background colors |
| table-zebra-rows | <span class="badge badge-xs badge-success badge-soft">Style</span> | Alternating row background on tbody rows only |
| table-zebra-cols | <span class="badge badge-xs badge-success badge-soft">Style</span> | Alternating column background colors |
| table-hover | <span class="badge badge-xs badge-success badge-soft">Style</span> | Highlights rows on hover |
| table-pin-rows | <span class="badge badge-xs badge-secondary badge-soft">Modificateur</span> | Sticks header and footer rows while scrolling |
| table-pin-cols | <span class="badge badge-xs badge-secondary badge-soft">Modificateur</span> | Sticks first and last columns while scrolling |
| table-xs | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Extra small row padding |
| table-sm | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Small row padding |
| table-md | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Medium row padding (default) |
| table-lg | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Large row padding |
| table-xl | <span class="badge badge-xs badge-info badge-soft">Taille</span> | Extra large row padding |
