---
name: "定价"
heading: "Tailwind CSS 定价块"
description: "仅 CSS Tailwind CSS 定价块使用卡片和按钮组件构建。复制粘贴带有等级、功能列表和 CTA 的定价表。 WCAG AA 可访问，可与 Django、HTMX、Laravel、React 和任何堆栈配合使用。"
metaTitle: "定价|仅 CSS Tailwind CSS 块 |Frutjam"
metaDescription: "仅限 CSS Tailwind CSS 定价组件。无需 JavaScript，可访问 WCAG，可与 Django、HTMX、Laravel、React 和任何框架配合使用。"
order: 0
related:
  - "components/card"
  - "components/button"
...
该定价块由 [card 组件](/components/card) 和 [button](/components/button) 变体构建。
