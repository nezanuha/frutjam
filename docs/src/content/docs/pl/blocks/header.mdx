...
description: "Bloki nagłówka CSS Tailwind tylko dla CSS z paskiem nawigacyjnym, brandingiem i mobilną szufladą. Przyklejone, przejrzyste i responsywne warianty układu. Dostępny WCAG AA, współpracuje z Django, HTMX, Laravel, React i dowolnym stosem."
metaTitle: "Nagłówek | Blok CSS Tailwind tylko dla CSS | Frutjam"
metaDescription: "Bloki nagłówka CSS Tailwind tylko dla CSS z lepkimi, responsywnymi i markowymi układami. Brak JavaScript, dostępny WCAG AA. Współpracuje z Django, HTMX, Laravel, React i dowolnym stosem."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Gotowe układy nagłówków zbudowane z komponentu [header](/components/header) , [navbar](/components/navbar) i [drawer](/components/drawer) dla urządzeń mobilnych.
