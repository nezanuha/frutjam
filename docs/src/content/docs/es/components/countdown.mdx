---
name: "Cuenta atrás"
heading: "Componente de cuenta regresiva"
description: "Temporizador de cuenta regresiva CSS Tailwind solo para CSS. Visualización de números animados para días, horas, minutos y segundos. Accesible a WCAG AA, funciona con Django, HTMX, Laravel, React y cualquier pila."
metaTitle: "Countdown - Componente CSS Tailwind solo para CSS | Frutjam"
metaDescription: "Tailwind CSS Countdown para lanzamientos de eventos, ventas flash y fechas límite. Admite días, horas, minutos y segundos con diseños animados flexibles."
order: 0
related:
  - "components/stat"
  - "components/badge"
image: "https://cdn.frutjam.com/media/components/countdown_CQdyWIi.webp"
imageAlt: "Cuenta atrás de Frutjam"
createdAt: "2026-04-19T15:56:37.063056+00:00"
updatedAt: "2026-07-13T09:52:22.878683+00:00"
sourceHash: "7a4576b06648"
translationHash: "0861cc4484b1"
---
...
Los componentes de cuenta regresiva muestran el tiempo restante hasta que finalice un evento, fecha límite o promoción. Construidas con pantallas numéricas animadas, las cuentas regresivas crean urgencia y anticipación. El sistema de cuenta regresiva de Frutjam admite múltiples tamaños, formatos y estilos, ideal para ventas flash, cronómetros de eventos, cuentas regresivas de lanzamientos y ofertas por tiempo limitado.
...
| --- | --- | --- |
| countdown | <span class="badge badge-xs">Base</span> | Dígito numérico animado impulsado por `--countdown-value` |
| countdown-xs | <span class="badge badge-xs badge-info badge-soft">Tamaño</span> | extrapequeño |
| countdown-sm | <span class="badge badge-xs badge-info badge-soft">Tamaño</span> | Pequeño |
| countdown-md | <span class="badge badge-xs badge-info badge-soft">Tamaño</span> | Medio (predeterminado) |
| countdown-lg | <span class="badge badge-xs badge-info badge-soft">Tamaño</span> | Grande |
| countdown-xl | <span class="badge badge-xs badge-info badge-soft">Tamaño</span> | Extra grande |
