---
title: Header Block
description: Full-page header block with logo, nav, and mobile drawer.
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

<p>Ready-made header layouts built with the <a href="">header component</a>, <a href="">navbar</a>, and <a href="">drawer</a> for mobile.</p>
