---
title: Diff
description: Diff components display differences between two versions of content, ideal for showing code changes, document revisions, or comparison views. Built with semanti
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

<p>Diff components display differences between two versions of content, ideal for showing code changes, document revisions, or comparison views. Built with semantic HTML and color-coded styling, diffs help users understand what changed. The Frutjam diff system supports multiple types and styles—perfect for version control interfaces, revision history, and change tracking.</p>
...
<div class="overflow-y-auto max-h-72">
  <table class="table table-sm not-prose">
    ...
    <tbody>
      <tr><td>diff</td><td><span class="badge badge-xs">Base</span></td><td>Side-by-side comparison container with a draggable divider</td></tr>
      <tr><td>diff-item-1</td><td><span class="badge badge-xs badge-secondary badge-soft">Modifier</span></td><td>Left (before) pane of the comparison</td></tr>
      <tr><td>diff-item-2</td><td><span class="badge badge-xs badge-secondary badge-soft">Modifier</span></td><td>Right (after) pane of the comparison</td></tr>
      <tr><td>diff-resizer</td><td><span class="badge badge-xs badge-secondary badge-soft">Modifier</span></td><td>Draggable handle to resize the two panes</td></tr>
    </tbody>
  </table>
</div>

<h2>Basic Usage</h2>
<p>Create a simple side-by-side diff with before and after states.</p>
...
<h2>Diff Text Comparison</h2>
<p>Display code or text changes side-by-side for detailed comparison.</p>
...
<h2>Diff with Color Coding</h2>
<p>Use semantic colors to highlight removed, added, or changed content.</p>
...
<p>Compare visual changes between before and after images with draggable resizer.</p>
...
<h2>Diff Sizes</h2>
<p>Control the diff size using width and height utilities on the container.</p>
