...
description: "Blocos de cabeçalho CSS Tailwind somente CSS com barra de navegação, marca e gaveta móvel. Variantes de layout fixas, transparentes e responsivas. WCAG AA acessível, funciona com Django, HTMX, Laravel, React e qualquer pilha."
metaTitle: "Cabeçalho | Bloco CSS Tailwind somente CSS | Frutjam"
metaDescription: "Blocos de cabeçalho CSS Tailwind somente CSS com layouts fixos, responsivos e de marca. Sem JavaScript, WCAG AA acessível. Funciona com Django, HTMX, Laravel, React e qualquer pilha."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Layouts de cabeçalho prontos criados com o componente [header](/components/header), [navbar](/components/navbar) e [drawer](/components/drawer) para dispositivos móveis.
