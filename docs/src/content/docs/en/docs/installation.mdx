...
<RawHtml html={"<div class=\"not-prose\"><div class=\"card card-outline card-sm mt-6\"><div class=\"card-content\"><p class=\"badge badge-info badge-soft mb-2\">Starter project</p><h3 class=\"card-title mb-2\">Building with Django?</h3><p class=\"para-sm mb-3\">A working Django 6 project with Frutjam already wired up — accounts, a dashboard, themes and a markdown-backed CRUD example. Clone it and start building.</p><a href=\"https://github.com/nezanuha/django-frutjam-starter\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"btn btn-sm btn-primary\">Get the Django starter →</a></div></div></div>"} />
