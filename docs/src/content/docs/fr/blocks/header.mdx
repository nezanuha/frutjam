...
description: "Blocs d'en-tête CSS Tailwind uniquement CSS avec barre de navigation, image de marque et tiroir mobile. Variantes de mise en page collantes, transparentes et réactives. WCAG AA accessible, fonctionne avec Django, HTMX, Laravel, React et n'importe quelle pile."
metaTitle: "En-tête | Bloc CSS Tailwind uniquement CSS | Frutjam"
metaDescription: "Blocs d'en-tête CSS Tailwind uniquement CSS avec des mises en page collantes, réactives et de marque. Pas de JavaScript, WCAG AA accessible. Fonctionne avec Django, HTMX, Laravel, React et n'importe quelle pile."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Mises en page d'en-tête prêtes à l'emploi créées avec le composant [header](/components/header), [navbar](/components/navbar) et [drawer](/components/drawer) pour mobile.
