---
name: "Alarm"
heading: "Komponent alertu"
description: "Alert CSS Tailwind zawierający wyłącznie informacje, informacje o powodzeniu, ostrzeżenia i warianty błędów. Miękki styl, miejsce na ikonę i wzór do odrzucenia. Dostępny WCAG AA, współpracuje z Django, HTMX, Laravel, React i dowolnym stosem."
metaTitle: "Alert — komponent CSS Tailwind tylko dla CSS | Frutjam"
metaDescription: "Alert CSS Tailwind bez JS z informacjami, sukcesem, ostrzeżeniami i wariantami błędów. Dostępne, obsługujące ikony i obsługujące motywy w celu zapewnienia skutecznych powiadomień na stronie."
order: 0
related:
  - "components/toast"
  - "components/button"
...
| Klasa | Typ | Opis |
| --- | --- | --- |
| alert | <span class="badge badge-xs">Opierać</span> | Kontekstowy baner wiadomości |
| alert-outline | <span class="badge badge-xs badge-success badge-soft">Styl</span> | Przezroczyste wypełnienie z kolorową obwódką |
| alert-soft | <span class="badge badge-xs badge-success badge-soft">Styl</span> | Stonowane przyciemnione tło |
| alert-ghost | <span class="badge badge-xs badge-success badge-soft">Styl</span> | Subtelne tło bez obramowania |
| alert-dashed | <span class="badge badge-xs badge-success badge-soft">Styl</span> | Styl przerywanej granicy |
| alert-pill | <span class="badge badge-xs badge-success badge-soft">Styl</span> | W pełni zaokrąglony kształt pigułki |
| alert-rounded | <span class="badge badge-xs badge-success badge-soft">Styl</span> | Umiarkowane zaokrąglenie |
| alert-horizontal | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Poziomy układ elastyczny |
| alert-vertical | <span class="badge badge-xs badge-secondary badge-soft">Modyfikator</span> | Pionowy układ skumulowany |
| alert-xs | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Bardzo mały |
| alert-sm | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Mały |
| alert-md | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Średni (domyślny) |
| alert-lg | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Duży |
| alert-primary | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Podstawowy kolor motywu |
| alert-secondary | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Kolor motywu drugorzędnego |
| alert-accent | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Kolor motywu akcentującego |
| alert-neutral | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Neutralny kolor motywu |
| alert-info | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Kolor semantyczny informacji |
| alert-success | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Sukces semantyczny kolor |
| alert-warning | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Ostrzeżenie kolor semantyczny |
| alert-error | <span class="badge badge-xs badge-warning badge-soft">Kolor</span> | Błąd koloru semantycznego |
...
## Układ i zachowanie alertów

### Alerty o pełnej szerokości

Użyj klasy użytkowej `w-full`, aby **alert** obejmował całą szerokość kontenera. Działa to ze wszystkimi wariantami kolorów i stylów.
...
### Responsywne układanie alertów

Ten alert układa się pionowo na urządzeniu mobilnym i rozwija się poziomo na komputerze, zapewniając optymalne wykorzystanie ekranu.
