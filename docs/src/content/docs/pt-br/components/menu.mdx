---
name: "Menu"
heading: "Componente do menu"
description: "Menu vertical Tailwind CSS somente CSS para listas de navegação. Estados de itens ativos, desativados e de ícone. Variantes de tamanho. WCAG AA acessível, funciona com Django, HTMX, Laravel, React e qualquer pilha."
metaTitle: "Menu - Componente Tailwind CSS somente CSS | Frutjam"
metaDescription: "Menu CSS do Tailwind para listas de navegação, barras laterais e menus suspensos. Ícones, estados ativos e submenus aninhados — totalmente acessíveis sem JavaScript."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
| Aula | Tipo | Descrição |
| --- | --- | --- |
| menu | <span class="badge badge-xs">Base</span> | Lista vertical de itens de navegação ou ação |
| menu-item | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Item clicável individual dentro do menu |
| menu-title | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Etiqueta de seção não interativa |
| menu-horizontal | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Layout horizontal |
| menu-vertical | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Layout vertical (padrão) |
| menu-active | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Força o estado ativo/destacado em um item |
| menu-disabled | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Aparência desativada para um item de menu |
| menu-xs | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Extra pequeno |
| menu-sm | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Pequeno |
| menu-md | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Médio (padrão) |
| menu-lg | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Grande |
| menu-xl | <span class="badge badge-xs badge-info badge-soft">Tamanho</span> | Extra grande |
...
## Menu responsivo: vertical na tela pequena, horizontal na tela grande
...
## Menu com linha vertical com título como pai
...
## Menu vertical apenas com ícone
...
## Menu horizontal apenas com ícone
...
## Menu com ícone apenas com dica de ferramenta
...
## Menu apenas com ícone (horizontal) com dica de ferramenta
...
## Mega menu com submenu (responsivo)
...
## Dobrável com submenu (responsivo)
