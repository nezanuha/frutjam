...
description: "CSS-only Tailwind CSS table with zebra striping, compact and default sizes, pinned columns, and row hover states. WCAG AA accessible, works with Django, HTMX, Laravel, React, and any stack."
metaTitle: "Table - CSS-Only Tailwind CSS Component | Frutjam"
metaDescription: "Tailwind CSS Table with striped rows, sticky headers, and compact sizing. Semantic HTML for accessible, responsive data display in dashboards and listings."
order: 0
related:
  - "components/checkbox"
  - "components/button"
...
imageAlt: "Table components by Frutjam UI"
...
CSS-only Tailwind CSS table with zebra striping, compact and default sizes, pinned columns, and row hover states. WCAG AA accessible, works with Django, HTMX, Laravel, React, and any stack.
...
| table-pin-rows | <span class="badge badge-xs badge-secondary badge-soft">Modifier</span> | Sticks header and footer rows while scrolling |
| table-pin-cols | <span class="badge badge-xs badge-secondary badge-soft">Modifier</span> | Sticks first and last columns while scrolling |
| table-xs | <span class="badge badge-xs badge-info badge-soft">Size</span> | Extra small row padding |
| table-sm | <span class="badge badge-xs badge-info badge-soft">Size</span> | Small row padding |
| table-md | <span class="badge badge-xs badge-info badge-soft">Size</span> | Medium row padding (default) |
| table-lg | <span class="badge badge-xs badge-info badge-soft">Size</span> | Large row padding |
| table-xl | <span class="badge badge-xs badge-info badge-soft">Size</span> | Extra large row padding |
