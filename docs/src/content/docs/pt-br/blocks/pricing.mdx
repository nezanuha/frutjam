---
name: "Preços"
heading: "Blocos de preços CSS Tailwind"
description: "Blocos de preços Tailwind CSS somente CSS criados com componentes de cartão e botão. Copie e cole tabelas de preços com níveis, listas de recursos e CTAs. WCAG AA acessível, funciona com Django, HTMX, Laravel, React e qualquer pilha."
metaTitle: "Preços | Blocos CSS Tailwind somente CSS | Frutjam"
metaDescription: "Componente Tailwind CSS Pricing somente CSS. Não é necessário JavaScript, é acessível por WCAG, funciona com Django, HTMX, Laravel, React e qualquer estrutura."
order: 0
related:
  - "components/card"
  - "components/button"
...
Este bloco de preços é construído com as variantes [card component](/components/card) e [button](/components/button).
