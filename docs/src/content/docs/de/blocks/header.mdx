...
description: "Nur CSS-CSS-Header-Blöcke von Tailwind mit Navigationsleiste, Branding und mobiler Schublade. Klebrige, transparente und responsive Layoutvarianten. WCAG AA zugänglich, funktioniert mit Django, HTMX, Laravel, React und jedem Stack."
metaTitle: "Kopfzeile | Nur CSS-Tailwind-CSS-Block | Frutjam"
metaDescription: "Nur CSS-CSS-Header-Blöcke von Tailwind mit Sticky-, Responsive- und Markenlayouts. Kein JavaScript, WCAG AA zugänglich. Funktioniert mit Django, HTMX, Laravel, React und jedem Stack."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Vorgefertigte Header-Layouts, erstellt mit den [header-Komponenten](/components/header) , [navbar](/components/navbar) und [drawer](/components/drawer) für Mobilgeräte.
