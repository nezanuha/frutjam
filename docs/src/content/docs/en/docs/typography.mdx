...
name: "Typography"
heading: "Typography"
description: "Frutjam's CSS-only typography system. Semantic HTML text scaling with Tailwind CSS v4, WCAG accessible, no JavaScript required. Works with Django, HTMX, Laravel, React, and any framework."
metaTitle: "Tailwind CSS Typography -Semantic HTML Text Styles | Frutjam"
metaDescription: "Frutjam typography system. Semantic HTML text scaling with CSS variables, WCAG accessible, Tailwind CSS v4 compatible."
order: 3
related:
  - "docs/themes"
  - "docs/colors"
image: "https://cdn.frutjam.com/media/docs/typography.webp"
imageAlt: "Typography - Frutjam"
...
Frutjam's CSS-only typography system for Tailwind CSS v4. Semantic heading and paragraph scale, responsive layout utilities, and prose integration — no JavaScript required, WCAG AA accessible. Works with Django, HTMX, Laravel, React, and any stack.
