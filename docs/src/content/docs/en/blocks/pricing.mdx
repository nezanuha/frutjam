---
name: "Pricing"
heading: "Tailwind CSS Pricing Blocks"
description: "CSS-only Tailwind CSS pricing blocks built with card and button components. Copy-paste pricing tables with tiers, feature lists, and CTAs. WCAG AA accessible, works with Django, HTMX, Laravel, React, and any stack."
metaTitle: "Pricing | CSS-Only Tailwind CSS Blocks | Frutjam"
metaDescription: "CSS-only Tailwind CSS Pricing component. No JavaScript required, WCAG accessible, works with Django, HTMX, Laravel, React, and any framework."
order: 0
related:
  - "components/card"
  - "components/button"
...
imageAlt: "Pricing UI Blocks by Frutjam"
...
This pricing block is built with the [card component](/components/card) and [button](/components/button) variants.
