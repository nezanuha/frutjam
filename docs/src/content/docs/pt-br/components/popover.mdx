---
name: "Popover"
heading: "Componente Popover"
description: "Popover CSS Tailwind somente CSS usando a API popover nativa. Painel de conteúdo flutuante para dicas de ferramentas e menus suspensos. WCAG AA acessível, funciona com Django, HTMX, Laravel, React e qualquer pilha."
metaTitle: "Menu suspenso e popover CSS do Tailwind - somente CSS | Frutjam"
metaDescription: "Menu suspenso e popover CSS do Tailwind somente CSS. API HTMX Popover nativa, menus suspensos da barra de navegação, menus de perfil — sem JavaScript. WCAG acessível, Django, HTMX, Larave"
order: 0
related:
  - "components/button"
  - "components/tooltip"
image: "https://cdn.frutjam.com/media/components/popover.webp"
imageAlt: "Blocos Popover por Frutjam UI"
createdAt: "2026-01-15T05:30:51.470004+00:00"
updatedAt: "2026-07-13T09:43:43.541052+00:00"
sourceHash: "959583800dce"
translationHash: "38f32b79a59d"
---
...
Os componentes popover exibem conteúdo contextual adjacente aos elementos acionadores sem ocupar espaço permanente na tela. Construído na API HTML Popover nativa, o sistema popover Frutjam suporta gatilhos de clique e foco, posicionamento personalizável e animações suaves. Perfeito para menus suspensos, menus de contexto, menus de perfil de usuário e opções adicionais sem navegação de página.

Somente CSS, sem necessidade de JavaScript – crie menus suspensos acessíveis e sobreposições contextuais com HTMX puro e CSS Tailwind. WCAG AA acessível e independente de estrutura - funciona com Django, HTMX, Laravel, React e qualquer pilha.

<DocTable wrapper="overflow-y-auto max-h-72" table="table table-sm not-prose">

| Aula | Tipo | Descrição |
| --- | --- | --- |
| popover | <span class="badge badge-xs">Base</span> | Wrapper que ancora o gatilho e o conteúdo juntos |
| popover-content | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Painel flutuante mostrado quando o popover está aberto |
| popover-toggle | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Elemento gatilho que abre/fecha o popover |
| popover-hover | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Abre ao passar o mouse em vez de clicar |
| popover-top-start | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado acima, alinhado ao início |
| popover-top-center | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado acima, centralizado |
| popover-top-end | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado acima, alinhado ao final |
| popover-bottom-start | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado abaixo, alinhado ao início |
| popover-bottom-center | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado abaixo, centralizado |
| popover-bottom-end | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado abaixo, alinhado ao final |
| popover-start-top | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado à esquerda, alinhado ao topo |
| popover-start-center | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado à esquerda, centralizado verticalmente |
| popover-start-bottom | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado à esquerda, alinhado à parte inferior |
| popover-end-top | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado à direita, alinhado ao topo |
| popover-end-center | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado à direita, centralizado verticalmente |
| popover-end-bottom | <span class="badge badge-xs badge-secondary badge-soft">Modificador</span> | Posicionado à direita, alinhado à parte inferior |
...
Use o componente Popover para criar menus suspensos – menus suspensos de navegação, menus de perfil de usuário e menus de ação – todos somente CSS, sem necessidade de JavaScript.

### Menu suspenso da barra de navegação
...
### Lista suspensa de perfil de usuário
...
## Comportamento de interação popover

Por padrão, as interações de clique são usadas para abrir e fechar o componente popover. Para megamenus, por exemplo, você pode ativar a interação baseada em foco adicionando a classe `popover-hover` e removendo os atributos `popovertarget` e `popover`. Isso permite que o popover seja totalmente controlado por meio da lógica de foco, em vez do comportamento de clique nativo.

### Gatilho de clique nativo
...
## Opções de posicionamento popover (superior, inferior, início, fim)

Posicione seus popovers em relação aos elementos acionadores usando nossa lógica de posicionamento flexível. O posicionamento popover é criado combinando opções de alinhamento vertical (superior, central, inferior) e horizontal (início, centro, fim).

### Posição popover inicial
...
### Posição popover superior central
...
### Posição popover final-inferior
...
### Posição popover inferior central
...
### Posição popover do centro inicial
...
### Posição popover inicial-inferior
...
## Usando popovers dentro de tabelas de dados (menus de ação e confirmações)
