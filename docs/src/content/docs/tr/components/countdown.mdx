---
name: "Geri sayım"
heading: "Geri Sayım Bileşeni"
description: "Yalnızca CSS'ye özgü Tailwind CSS geri sayım sayacı. Günler, saatler, dakikalar ve saniyeler için animasyonlu sayı ekranı. WCAG AA'ya erişilebilir; Django, HTMX, Laravel, React ve herhangi bir yığınla çalışır."
metaTitle: "Geri Sayım - Yalnızca CSS'de Tailwind CSS Bileşeni | Frutjam"
metaDescription: "Etkinlik lansmanları, hızlı indirimler ve son tarihler için Tailwind CSS Geri Sayımı. Esnek, animasyonlu düzenlerle günleri, saatleri, dakikaları ve saniyeleri destekler."
order: 0
related:
  - "components/stat"
  - "components/badge"
image: "https://cdn.frutjam.com/media/components/countdown_CQdyWIi.webp"
imageAlt: "Frutjam'dan geri sayım"
createdAt: "2026-04-19T15:56:37.063056+00:00"
updatedAt: "2026-07-13T09:52:22.878683+00:00"
sourceHash: "7a4576b06648"
translationHash: "b8b1b55fd77a"
---
...
| Sınıf | Tip | Tanım |
| --- | --- | --- |
| countdown | <span class="badge badge-xs">Temel</span> | `--countdown-value` tarafından yönlendirilen animasyonlu sayısal rakam |
| countdown-xs | <span class="badge badge-xs badge-info badge-soft">Boyut</span> | Ekstra küçük |
| countdown-sm | <span class="badge badge-xs badge-info badge-soft">Boyut</span> | Küçük |
| countdown-md | <span class="badge badge-xs badge-info badge-soft">Boyut</span> | Orta (varsayılan) |
| countdown-lg | <span class="badge badge-xs badge-info badge-soft">Boyut</span> | Büyük |
| countdown-xl | <span class="badge badge-xs badge-info badge-soft">Boyut</span> | Ekstra büyük |
