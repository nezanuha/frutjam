---
name: "Có thể thu gọn"
heading: "Thành phần có thể thu gọn"
description: "Bảng điều khiển có thể thu gọn CSS Tailwind chỉ bằng CSS sử dụng phần tử `<details>` gốc. Hiển thị và ẩn các phần nội dung không có JavaScript. WCAG AA có thể truy cập được, hoạt động với Django, HTMX, Laravel, React và bất kỳ ngăn xếp nào."
metaTitle: "Có thể thu gọn - Thành phần CSS Tailwind chỉ dành cho CSS | Frutjam"
metaDescription: "CSS Tailwind không có JS Có thể thu gọn bằng cách sử dụng chi tiết/tóm tắt gốc. Tiết lộ có thể truy cập cho Câu hỏi thường gặp, điều hướng lồng nhau và các phần nội dung có thể mở rộng."
order: 0
related:
  - "components/tabs"
  - "components/accordion"
image: "https://cdn.frutjam.com/media/components/collapsible_pOIxxIe.webp"
imageAlt: "Có thể thu gọn bởi Frutjam"
createdAt: "2026-04-19T15:56:32.406115+00:00"
updatedAt: "2026-07-13T09:43:01.618283+00:00"
sourceHash: "faedd5abd13e"
translationHash: "b9b49ba5875d"
---
...
| --- | --- | --- |
| collapsible | <span class="badge badge-xs">Căn cứ</span> | Collapsible container driven by a hidden checkbox |
| collapsible-toggle | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Hidden checkbox input that controls open/close state |
| collapsible-title | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Clickable label that toggles the collapsible |
| collapsible-content | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Animated content area revealed when open |
| collapsible-arrow | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Adds a rotating arrow indicator to the title |
| collapsible-group | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Wrapper for accordion-style grouped collapsibles |
| collapsible-overlay | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Overlay variant for drawer-style collapsibles |
| collapsible-peek | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | Shows a glimpse of content when collapsed |
| is-collapsible-open | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | JS-applied class to force open state |
| is-collapsible-close | <span class="badge badge-xs badge-secondary badge-soft">Công cụ sửa đổi</span> | JS-applied class to force closed state |
...
Chuyển đổi `collapsible-open` trên phần tử trình bao bọc thay vì sử dụng hộp kiểm — hữu ích khi trình kích hoạt tồn tại ở nơi khác.
