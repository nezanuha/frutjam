...
description: "Gezinme çubuğu, markalama ve mobil çekmece içeren, yalnızca CSS'ye özel Tailwind CSS başlık blokları. Yapışkan, şeffaf ve duyarlı düzen çeşitleri. WCAG AA'ya erişilebilir; Django, HTMX, Laravel, React ve herhangi bir yığınla çalışır."
metaTitle: "Başlık | Yalnızca CSS Arka Rüzgar CSS Bloğu | Frutjam"
metaDescription: "Yapışkan, duyarlı ve markalı düzenlere sahip, yalnızca CSS'ye özel Tailwind CSS başlık blokları. JavaScript yok, WCAG AA'ya erişilebilir. Django, HTMX, Laravel, React ve herhangi bir yığınla çalışır."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Mobil cihazlar için [header bileşeni](/components/header), [navbar](/components/navbar) ve [drawer](/components/drawer) ile oluşturulmuş hazır başlık düzenleri.
