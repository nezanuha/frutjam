...
name: "kiểu chữ"
heading: "kiểu chữ"
description: "Hệ thống kiểu chữ chỉ CSS của Frutjam. Chia tỷ lệ văn bản HTML ngữ nghĩa bằng Tailwind CSS v4, có thể truy cập WCAG, không cần JavaScript. Hoạt động với Django, HTMX, Laravel, React và bất kỳ framework nào."
metaTitle: "Kiểu chữ CSS Tailwind - Kiểu văn bản HTML ngữ nghĩa | Frutjam"
metaDescription: "Hệ thống kiểu chữ Frutjam. Chia tỷ lệ văn bản HTML ngữ nghĩa bằng các biến CSS, có thể truy cập WCAG, tương thích với Tailwind CSS v4."
order: 3
related:
  - "docs/themes"
  - "docs/colors"
