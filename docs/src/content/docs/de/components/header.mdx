---
name: "Kopfzeile"
heading: "Header-Komponente"
description: "Nur CSS-Seitenkopf von Tailwind CSS – oberes Leistenlayout mit Marke, Navigation und Aktionsfeldern. WCAG AA zugänglich, funktioniert mit Django, HTMX, Laravel, React und jedem Stack."
metaTitle: "Header – Nur CSS-Tailwind-CSS-Komponente | Frutjam"
metaDescription: "Tailwind CSS-Header mit Sticky-, Responsive- und Markenlayouts. Semantische HTML5-Struktur mit Navigation und Aktionsslots für moderne Website-Header."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Header-Komponenten erstellen konsistente Top-Navigations- und Branding-Bereiche für Ihre Website oder Anwendung. Das Frutjam-Header-System besteht aus semantischen HTML-Header-Elementen und kombiniert Logos, Navigationslinks und Benutzeraktionen in einer zusammenhängenden, reaktionsfähigen Leiste. Unterstützt mehrere Layouts und Ausrichtungsoptionen und lässt sich nahtlos in Dropdown- und Suchfunktionen integrieren.
...
| --- | --- | --- |
| header | <span class="badge badge-xs">Base</span> | Container der oberen Navigationsleiste |
| header-content | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Dreispaltiges Rasterlayout (Anfang / Mitte / Ende) |
| header-start | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Linker Schlitz, normalerweise für das Logo |
| header-center | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Mittlerer Schlitz für Navigationslinks |
| header-end | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Rechter Steckplatz für Aktionen und Steuerung |
| header-sticky | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Bleibt beim Scrollen oben hängen |
| header-fixed | <span class="badge badge-xs badge-secondary badge-soft">Modifikator</span> | Feste Position, immer sichtbar |
| header-solid | <span class="badge badge-xs badge-success badge-soft">Stil</span> | Fester undurchsichtiger Hintergrund |
| header-transparent | <span class="badge badge-xs badge-success badge-soft">Stil</span> | Transparenter Hintergrund |
| header-blur | <span class="badge badge-xs badge-success badge-soft">Stil</span> | Unschärfeeffekt aus Milchglas |
| header-shadow | <span class="badge badge-xs badge-success badge-soft">Stil</span> | Fügt einen Schlagschatten unter der Kopfzeile hinzu |
| header-sm | <span class="badge badge-xs badge-info badge-soft">Größe</span> | Kleine (kompakte) Höhe |
| header-lg | <span class="badge badge-xs badge-info badge-soft">Größe</span> | Große Höhe |

</DocTable>

## Grundlegende Verwendung

Der Header verwendet ein dreispaltiges Raster über `header-content`: `header-start` (Logo), `header-center` (optional zentrierte Navigation) und `header-end` (Aktionen und mobiles Umschalten).
...
Platzieren Sie die Navigation innerhalb von `header-center`, um sie an der mittleren Spalte anzuheften. Der mobile Umschalter bleibt in `header-end`.
...
### Zentrierte Navigation mit Aktionsschaltflächen

Platzieren Sie Aktionsschaltflächen neben dem mobilen Umschalter innerhalb von `header-end`. Bei responsiven Klassen werden beide ausgeblendet/angezeigt.
