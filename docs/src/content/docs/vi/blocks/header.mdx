...
description: "Khối tiêu đề CSS Tailwind chỉ có CSS ​​với thanh điều hướng, nhãn hiệu và ngăn kéo di động. Các biến thể bố cục cố định, minh bạch và đáp ứng. WCAG AA có thể truy cập được, hoạt động với Django, HTMX, Laravel, React và bất kỳ ngăn xếp nào."
metaTitle: "Tiêu đề | Khối CSS Tailwind chỉ dành cho CSS | Frutjam"
metaDescription: "Các khối tiêu đề CSS Tailwind chỉ có CSS ​​với bố cục hấp dẫn, phản hồi nhanh và có thương hiệu. Không có JavaScript, WCAG AA có thể truy cập được. Hoạt động với Django, HTMX, Laravel, React và bất kỳ ngăn xếp nào."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Khối tiêu đề CSS Tailwind chỉ có CSS ​​với thanh điều hướng, nhãn hiệu và ngăn kéo di động. Các biến thể bố cục cố định, minh bạch và đáp ứng. WCAG AA có thể truy cập được, hoạt động với Django, HTMX, Laravel, React và bất kỳ ngăn xếp nào.

Bố cục tiêu đề được tạo sẵn được xây dựng bằng thành phần [header](/components/header), [navbar](/components/navbar) và [drawer](/components/drawer) dành cho thiết bị di động.
