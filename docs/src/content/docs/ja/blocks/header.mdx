...
name: "ヘッダ"
heading: "ヘッダーコンポーネント"
description: "CSS のみの Tailwind CSS ヘッダー ブロック。ナビゲーションバー、ブランディング、モバイル ドロワーを備えています。スティッキー、透明、レスポンシブなレイアウトのバリエーション。 WCAG AA にアクセス可能で、Django、HTMX、Laravel、React、およびあらゆるスタックで動作します。"
metaTitle: "ヘッダー | CSS のみの Tailwind CSS ブロック |Frutjam"
metaDescription: "CSS のみの Tailwind CSS ヘッダー ブロック。スティッキーで応答性が高く、ブランド化されたレイアウトを備えています。 JavaScript なし、WCAG AA にアクセス可能。 Django、HTMX、Laravel、React、およびあらゆるスタックで動作します。"
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
モバイル用の [header コンポーネント](/components/header) 、[navbar](/components/navbar)、および [drawer](/components/drawer) で構築された既製のヘッダー レイアウト。
