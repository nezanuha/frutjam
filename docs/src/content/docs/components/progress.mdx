---
title: Progress
description: Progress components visualize the completion status of tasks, downloads, or multi-step processes. Built with semantic HTML progress elements and Tailwind CSS st
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

<p>Progress components visualize the completion status of tasks, downloads, or multi-step processes. Built with semantic HTML progress elements and Tailwind CSS styling, progress bars communicate progress clearly to users. The Frutjam progress system supports multiple colors, sizes, and animation states for flexible integration into loading screens, forms, and dashboards.</p>
...
<div class="overflow-y-auto max-h-72">
  <table class="table table-sm not-prose">
    ...
    <tbody>
      <tr><td>progress</td><td><span class="badge badge-xs">Base</span></td><td>Horizontal progress bar</td></tr>
      <tr><td>progress-primary</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Primary theme color</td></tr>
      <tr><td>progress-secondary</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Secondary theme color</td></tr>
      <tr><td>progress-accent</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Accent theme color</td></tr>
      <tr><td>progress-neutral</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Neutral theme color</td></tr>
      <tr><td>progress-info</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Info semantic color</td></tr>
      <tr><td>progress-success</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Success semantic color</td></tr>
      <tr><td>progress-warning</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Warning semantic color</td></tr>
      <tr><td>progress-error</td><td><span class="badge badge-xs badge-warning badge-soft">Color</span></td><td>Error semantic color</td></tr>
    </tbody>
  </table>
</div>
