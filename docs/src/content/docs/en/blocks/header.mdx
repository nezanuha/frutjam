...
description: "CSS-only Tailwind CSS header blocks with navbar, branding, and mobile drawer. Sticky, transparent, and responsive layout variants. WCAG AA accessible, works with Django, HTMX, Laravel, React, and any stack."
metaTitle: "Header | CSS-Only Tailwind CSS Block | Frutjam"
metaDescription: "CSS-only Tailwind CSS header blocks with sticky, responsive, and branded layouts. No JavaScript, WCAG AA accessible. Works with Django, HTMX, Laravel, React, and any stack."
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
Ready-made header layouts built with the [header component](/components/header), [navbar](/components/navbar), and [drawer](/components/drawer) for mobile.
