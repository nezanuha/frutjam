...
name: "メニュー"
heading: "メニューコンポーネント"
description: "CSS のみの Tailwind ナビゲーション リスト用の CSS 垂直メニュー。アクティブ、無効、およびアイコン項目の状態。サイズバリエーション。 WCAG AA にアクセス可能で、Django、HTMX、Laravel、React、およびあらゆるスタックで動作します。"
metaTitle: "メニュー - CSS のみ Tailwind CSS コンポーネント |Frutjam"
metaDescription: "Tailwind ナビゲーション リスト、サイドバー、ドロップダウン用の CSS メニュー。アイコン、アクティブな状態、およびネストされたサブメニュー - JavaScript なしで完全にアクセスできます。"
order: 0
related:
  - "components/navbar"
  - "components/drawer"
...
メニュー コンポーネントには、アクションまたはナビゲーション オプションの整理されたリストが表示されます。セマンティック HTML リストとリンク要素を使用して構築された Frutjam メニュー システムは、垂直および水平レイアウト、ネストされたメニュー、アイコン、およびアクティブ状態をサポートします。キーボード ナビゲーションで完全にアクセスできるメニューは、ドロップダウン、サイドバー、およびコンテキスト ナビゲーション パターンとシームレスに統合されます。
...
| クラス | タイプ | 説明 |
| --- | --- | --- |
| menu | <span class="badge badge-xs">ベース</span> | ナビゲーションまたはアクション項目の縦方向のリスト |
| menu-item | <span class="badge badge-xs badge-secondary badge-soft">修飾子</span> | メニュー内の個々のクリック可能な項目 |
| menu-title | <span class="badge badge-xs badge-secondary badge-soft">修飾子</span> | 非インタラクティブなセクションラベル |
| menu-horizontal | <span class="badge badge-xs badge-secondary badge-soft">修飾子</span> | 横型レイアウト |
| menu-vertical | <span class="badge badge-xs badge-secondary badge-soft">修飾子</span> | 縦型レイアウト (デフォルト) |
| menu-active | <span class="badge badge-xs badge-secondary badge-soft">修飾子</span> | 項目を強制的にアクティブ/ハイライト状態にします |
| menu-disabled | <span class="badge badge-xs badge-secondary badge-soft">修飾子</span> | メニュー項目の無効な外観 |
| menu-xs | <span class="badge badge-xs badge-info badge-soft">サイズ</span> | 極小 |
| menu-sm | <span class="badge badge-xs badge-info badge-soft">サイズ</span> | 小さい |
| menu-md | <span class="badge badge-xs badge-info badge-soft">サイズ</span> | 中 (デフォルト) |
| menu-lg | <span class="badge badge-xs badge-info badge-soft">サイズ</span> | 大きい |
| menu-xl | <span class="badge badge-xs badge-info badge-soft">サイズ</span> | 特大 |
...
## レスポンシブメニュー: 小さな画面では垂直、大きな画面では水平
