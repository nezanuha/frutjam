...
| `.value` benar sebelum diserahkan | ✅ | ❌ Kosongkan sampai formulir diserahkan |
...
| Ukuran bundel, di-gzip | 51 KB | 107 KB (JS+CSS) |
...
`$_POST['content']` berfungsi persis seperti area teks standar mana pun — masukkan dan penanganan formulir Anda yang sudah ada tidak memerlukan perubahan apa pun.
...
<RawHtml html={"<p class=\"text-sm\"><strong>Catatan:</strong> Inisialisasi plugin MarkdownEditor wajib</p>"} />
...
<RawHtml html={"<div class=\"not-prose my-6 p-4 rounded-lg border border-base-200 bg-base-50 flex flex-col sm:flex-row sm:items-center gap-3\"><div class=\"flex-1\"><p class=\"heading mb-2\">Apakah ini berguna?</p><p class=\"text-sm\">Bintang GitHub membantu pengembang lain menemukan editornya. Itu bagian dari <a href=\"https://github.com/nezanuha/frutjam\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"underline underline-offset-2\">buah-buahan</a>. Sebuah bintang di sana juga membantu.</p></div><a href=\"https://github.com/nezanuha/markdown-text-editor\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"btn btn-primary btn-sm shrink-0\">Bintangi di GitHub</a></div>"} />
