...
name: "按鈕"
heading: "按鈕組件"
description: "僅 CSS 的 Tailwind CSS 按鈕，具有主要、次要、重音、重影、輪廓和軟變體。尺寸為 xs-xl、載入狀態、停用和圖示按鈕。僅 CSS，WCAG AA，可與 Django、HTMX、Laravel、React 搭配使用。"
metaTitle: "按鈕 - 純 CSS Tailwind CSS 元件 |Frutjam"
metaDescription: "Tailwind CSS 按鈕具有實心、輪廓、幽靈和軟變體。多種尺寸、載入狀態和完整的鍵盤輔助功能—無需 JavaScript。"
order: 0
related:
  - "components/badge"
  - "components/card"
...
僅 CSS 的 Tailwind CSS 按鈕，具有主要、次要、重音、重影、輪廓和軟變體。尺寸為 xs-xl、載入狀態、停用和圖示按鈕。僅 CSS，WCAG AA，可與 Django、HTMX、Laravel、React 搭配使用。

按鈕元件是觸發操作或將使用者導航到新頁面的互動元素。 Frutjam 按鈕系統透過修飾符類提供多種尺寸、顏色和样式 - 全部採用 Tailwind CSS 實用程式優先方法構建，用於輕量級、高度可自訂的按鈕，可跨框架和項目無縫工作。
...
| 班級 | 類型 | 描述 |
| --- | --- | --- |
| btn | <span class="badge badge-xs">根據</span> | 樣式按鈕元素 |
| btn-outline | <span class="badge badge-xs badge-success badge-soft">風格</span> | 帶有彩色邊框的透明填充 |
| btn-soft | <span class="badge badge-xs badge-success badge-soft">風格</span> | 柔和的有色背景 |
| btn-ghost | <span class="badge badge-xs badge-success badge-soft">風格</span> | 微妙的背景僅在懸停時可見 |
| btn-dashed | <span class="badge badge-xs badge-success badge-soft">風格</span> | 虛線邊框樣式 |
| btn-plain | <span class="badge badge-xs badge-success badge-soft">風格</span> | 無背景或邊框，僅文本 |
| btn-link | <span class="badge badge-xs badge-success badge-soft">風格</span> | 樣式為文字超連結 |
| btn-pill | <span class="badge badge-xs badge-success badge-soft">風格</span> | 全圓形藥丸形狀 |
| btn-rounded | <span class="badge badge-xs badge-success badge-soft">風格</span> | 適度舍入 |
| btn-circle | <span class="badge badge-xs badge-success badge-soft">風格</span> | 圖示按鈕的等寬圓圈 |
| btn-square | <span class="badge badge-xs badge-success badge-soft">風格</span> | 方形，無圓角 |
| btn-block | <span class="badge badge-xs badge-secondary badge-soft">修飾符</span> | 全角塊按鈕 |
| btn-wide | <span class="badge badge-xs badge-secondary badge-soft">修飾符</span> | 比預設值更寬，並具有額外的水平填充 |
| btn-active | <span class="badge badge-xs badge-secondary badge-soft">修飾符</span> | 強制啟動/按下視覺狀態 |
| btn-disabled | <span class="badge badge-xs badge-secondary badge-soft">修飾符</span> | 非按鈕元素的禁用外觀 |
| btn-xs | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 特小號 |
| btn-sm | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 小的 |
| btn-md | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 中（預設） |
| btn-lg | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 大的 |
| btn-xl | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 特大號 |
| btn-2xl | <span class="badge badge-xs badge-info badge-soft">尺寸</span> | 2×特大號 |
| btn-primary | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 主要主題顏色 |
| btn-secondary | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 次要主題色 |
| btn-accent | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 強調主題顏色 |
| btn-neutral | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 中性主題色 |
| btn-info | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 訊息語意顏色 |
| btn-success | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 成功語意色 |
| btn-warning | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 警告語意顏色 |
| btn-error | <span class="badge badge-xs badge-warning badge-soft">顏色</span> | 錯誤語意顏色 |
