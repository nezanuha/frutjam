---
name: "Định giá"
heading: "Khối định giá CSS Tailwind"
description: "Các khối định giá CSS Tailwind chỉ dành cho CSS được xây dựng bằng các thành phần thẻ và nút. Sao chép và dán bảng giá với các bậc, danh sách tính năng và CTA. WCAG AA có thể truy cập được, hoạt động với Django, HTMX, Laravel, React và bất kỳ ngăn xếp nào."
metaTitle: "Định giá | Khối CSS Tailwind chỉ dành cho CSS | Frutjam"
metaDescription: "Thành phần định giá CSS Tailwind chỉ dành cho CSS. Không cần JavaScript, có thể truy cập WCAG, hoạt động với Django, HTMX, Laravel, React và bất kỳ framework nào."
order: 0
related:
  - "components/card"
  - "components/button"
...
Khối định giá này được xây dựng bằng các biến thể thành phần [card](/components/card) và [button](/components/button).
