---
name: "Odliczanie"
heading: "Element odliczający"
description: "Minutnik CSS Tailwind tylko dla CSS. Animowane wyświetlanie liczb dla dni, godzin, minut i sekund. Dostępny WCAG AA, współpracuje z Django, HTMX, Laravel, React i dowolnym stosem."
metaTitle: "Odliczanie — komponent CSS Tailwind tylko dla CSS | Frutjam"
metaDescription: "Tailwind CSS Odliczanie do inauguracji wydarzeń, sprzedaży flash i terminów. Obsługuje dni, godziny, minuty i sekundy dzięki elastycznym, animowanym układom."
order: 0
related:
  - "components/stat"
  - "components/badge"
image: "https://cdn.frutjam.com/media/components/countdown_CQdyWIi.webp"
imageAlt: "Odliczanie przez Frutjam"
createdAt: "2026-04-19T15:56:37.063056+00:00"
updatedAt: "2026-07-13T09:52:22.878683+00:00"
sourceHash: "7a4576b06648"
translationHash: "9fd14f2f0f03"
---
...
Elementy odliczające wyświetlają czas pozostały do ​​zakończenia wydarzenia, terminu lub promocji. Zbudowane z animowanych wyświetlaczy numerycznych, odliczanie wywołuje pilność i oczekiwanie. System odliczania Frutjam obsługuje wiele rozmiarów, formatów i stylów — idealnie nadaje się do sprzedaży błyskawicznej, liczników czasu wydarzeń, odliczania premier i ofert ograniczonych czasowo.
...
| Klasa | Typ | Opis |
| --- | --- | --- |
| countdown | <span class="badge badge-xs">Opierać</span> | Animowana cyfra sterowana przez `--countdown-value` |
| countdown-xs | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Bardzo mały |
| countdown-sm | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Mały |
| countdown-md | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Średni (domyślny) |
| countdown-lg | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Duży |
| countdown-xl | <span class="badge badge-xs badge-info badge-soft">Rozmiar</span> | Bardzo duży |
